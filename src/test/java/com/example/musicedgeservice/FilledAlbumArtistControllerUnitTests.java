...
public class FilledAlbumArtistControllerUnitTests {
    ...
    private Album album1 = new Album(001, 10);
    private Album album2 = new Album(002, 5);

    private Artist artistArtist1Album1 = new Artist("1", 001, "Justin Bieber", "0623964");
    private Artist artistArtist1Album2 = new Artist("1", 001, "Justin Bieber", "0623964");
    private Artist artistArtist2Album1 = new Artist("2", 002, "Shawn Mendes", "1734075");

    private List<Artist> allArtistsFromArtist1 = Arrays.asList(artistArtist1Album1, artistArtist1Album2);
    private List<Artist> allArtistsForAlbum1 = Arrays.asList(artistArtist1Album1, artistArtist2Album1);
    private List<Artist> allArtistsForAlbum2 = Arrays.asList(artistArtist1Album2);
    private List<Album> allAlbums = Arrays.asList(album1, album2);
